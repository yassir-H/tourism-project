...
// 1. Make sure this is ABOVE the seed route
const Destination = mongoose.model('Destination', DestinationSchema);
...
app.get('/api/destinations/seed', async (req, res) => {
    try {
        ...
        {title : "Visit Russia", description : "Enjoy the beautiful Rusky Island", location : "Vladivostok , Russia", price : 1350, image :"https://plus.unsplash.com/premium_photo-1681079526808-84047103b7c7?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=https://unsplash.com/photos/an-aerial-view-of-a-bridge-surrounded-by-clouds--ZlDn9n-_Xk%3D"}
        ];
